...
export const CRUD_MODULES = [
  ...
  { key: "loan_management", label: "السلف والقروض", hasApprove: true },
  ...
  { key: "accounting", label: "نظام الحسابات", hasApprove: true },
  { key: "settings", label: "الإعدادات", hasApprove: false },
  { key: "legal", label: "الشؤون القانونية", hasApprove: false },
  { key: "storage_dashboard", label: "لوحة التخزين", hasApprove: false },
  { key: "storage_units", label: "وحدات التخزين", hasApprove: false },
  { key: "storage_bookings", label: "حجوزات التخزين", hasApprove: true },
  { key: "storage_contracts", label: "عقود التخزين", hasApprove: false },
  { key: "storage_crm", label: "CRM العملاء", hasApprove: false },
];
...
const ROLE_CRUD_DEFAULTS = {
  ...
  hr: {
    ...
    loan_management: ["view", "create", "edit", "delete", "approve"],
    tasks: ["view", "create", "edit", "delete"],
    meetings: ["view", "create", "edit", "delete"],
    reports: ["view", "create"],
    finance: [],
  ...
  general_manager: {
    ...
    loan_management: ["view", "create", "edit", "approve"],
    tasks: ["view", "create", "edit", "delete"],
    meetings: ["view", "create", "edit", "delete"],
    reports: ["view", "create"],
    finance: ["view"],
    ...
    settings: ["view"],
    legal: ["view", "create", "edit", "delete"],
    storage_dashboard: ["view"],
    storage_units: ["view"],
    storage_bookings: ["view"],
    storage_contracts: ["view"],
    storage_crm: ["view"],
  },
  ceo: {
    ...
    legal: ["view", "create", "edit", "delete"],
    storage_dashboard: ["view", "create", "edit", "delete"],
    storage_units: ["view", "create", "edit", "delete"],
    storage_bookings: ["view", "create", "edit", "delete", "approve"],
    storage_contracts: ["view", "create", "edit", "delete"],
    storage_crm: ["view", "create", "edit", "delete"],
  },
  accountant: {
    employees: ["view"],
    attendance: ["view"],
    ...
    transfers: ["view"],
    recruitment: [],
    loan_management: ["view", "create", "edit"],
    tasks: ["view"],
    meetings: ["view"],
    reports: ["view", "create"],
    finance: ["view", "create", "edit", "delete", "approve"],
