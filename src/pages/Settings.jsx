...
const gosiEmployerTotalNew = gosiRates?.saudi_employee_new
  ? (
      gosiRates.saudi_employee_new.retirement +
      gosiRates.saudi_employee_new.occupational_hazards +
      gosiRates.saudi_employee_new.workers_support_fund
    ).toFixed(2)
  : "0.00";
  return (
    <div className="p-6 space-y-5 max-w-5xl mx-auto" dir="rtl">
    ...
    {gosiLoading || !gosiRates ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-xl border border-border p-5 space-y-4">
          ...
          <h3 className="font-semibold text-foreground flex items-center gap-2">
            🇸🇦 الموظف السعودي (نظام جديد)
          </h3>

          {!gosiRates.saudi_employee_new ? (
            <div className="text-center py-6 text-sm text-muted-foreground">
              لا توجد بيانات متاحة لهذا النظام
            </div>
          ) : (
            <>
              <Field
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    max={20}
                    value={
                      gosiRates.saudi_employee_new.employee_subscription
                    }
                    onChange={e =>
                      updateGosiField(
                        "saudi_employee_new",
              ...
              <div className="border-t border-border pt-4">
                ...
                <p className="text-sm font-medium text-foreground mb-3">
                  اشتراك صاحب العمل (إجمالي: {gosiEmployerTotalNew}%)
                </p>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        max={20}
                        value={
                          gosiRates.saudi_employee_new[f.key]
                        }
                        onChange={e =>
                          updateGosiField(
                            "saudi_employee_new",
